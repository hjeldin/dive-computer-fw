...
fn bme280_compensate_h_double32(_adc_h: i32, t_fine: i32) -> f64 {
    let h: f64;
    let dig_h1 = 76800.0;
...
impl<'a> BMP280<'a> {
    ...
    pub async fn set_mode(&mut self, _mode: u8) {
